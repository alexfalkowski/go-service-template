...
require (
	...
	github.com/alexfalkowski/go-service/v2 v2.2.0
...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploghttp v0.12.1 // indirect
	...
	go.opentelemetry.io/otel/sdk/log v0.12.1 // indirect
